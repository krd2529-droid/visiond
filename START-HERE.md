...
เวอร์ชันปัจจุบัน: **v0.14.353**

## ลำดับที่ต้องอ่าน

1. `visiond-mvp/VERSION.txt`
2. กติกา Active: `visiond-mvp/JARVIS-PATCH-PROTOCOL.md`
3. Patch ledger ล่าสุด: `visiond-mvp/patch-ledgers/v0.14.353.json`
...
เมื่อแตะ Frontend/UI ให้โหลด `visiond-mvp/VISIOND-UI-DESIGN-PROTOCOL.md` ตาม routing ใน Active Protocol

## กฎความถูกต้อง

- ใช้ลำดับอำนาจใน Active Protocol; คำสั่ง Boss และ Patch Scope ที่อนุมัติมีอำนาจเหนือ Roadmap/History
- เอกสารใน `visiond-mvp/work-history/visiond/` ใช้ค้นย้อนหลังและ Regression ไม่ใช่กติกา Active เว้นแต่ routing ระบุให้เปิดหัวข้อเฉพาะ
