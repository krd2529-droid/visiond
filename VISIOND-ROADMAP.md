...
- v0.14.173: V Easy store settings persistence, product image upload reliability, delete UX.
- v0.14.174: lock WEB/ADMIN displayed version to VERSION.txt through release stamping; prevent stale manual version drift.
