...
assert.match(version.trim(),/^v0\.14\.(249|250|251)$/);assert.match(index,/WEB v0\.14\.(249|250|251)/);assert.match(admin,/ADMIN v0\.14\.(249|250|251)/);assert.match(page,/v0\.14\.(249|250|251)/);assert.match(page,/build 014(249|250|251)/);
...
assert.equal(fallback.stage,'ready');assert.match(fallback.intent,/คอร์ส/);assert.match(fallback.suggested_reply,/กี่คอร์ส/);
