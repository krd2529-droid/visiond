...
// Feature: PROD-FILE-001 — ดาวน์โหลด แสดง หรือลบไฟล์สินค้าตามสิทธิ์ผู้ดูแล
...
export async function onRequestGet(ctx){
  ...
  if(await vision5Product(ctx.env,file.product_id))return json({error:'ไฟล์ของสินค้า Vision 5 ต้องจัดการผ่านหน้าระบบ Vision 5 เท่านั้น'},403);
