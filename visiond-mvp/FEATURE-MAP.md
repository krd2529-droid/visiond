...
- Creator portfolio: รวมค่าคอมที่ API ส่งจริงแบบรายวันและ 30 วันข้ามหลายช่อง, แสดงสินค้าที่ซิงก์ทั้งหมดเป็นตารางหัวคอลัมน์แบบเลื่อนได้, จัด Showcase A–F และลบสินค้า F ผ่าน `Remove Showcase Products` หลังตรวจ ownership, grade, scope และการยืนยันใน UI
