...
- การเพิ่มบล็อก EP: หน้าเริ่มด้วย editor EP 1; ทุกครั้งที่กด “เพิ่ม EP” ต้องคงบล็อกเดิมแบบเต็มที่เห็นเลข ชื่อ รายละเอียด คลิป เอกสาร และรูปตัวอย่างไว้บนหน้าโดยห้ามย่อเป็นการ์ดสรุป พร้อมเปิด editor EP ถัดไปทันทีโดยไม่รอ API หรืออัปโหลด จากนั้นปุ่มบันทึกร่างทั้งตะกร้าจึงส่งบล็อกตามลำดับ โดยบล็อกที่ส่งสำเร็จต้องถูกนำออกจากคิวเพื่อไม่สร้างซ้ำเมื่อ retry
