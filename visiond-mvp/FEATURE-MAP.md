...
- Creator portfolio: เลือกวันเริ่ม–สิ้นสุดเพื่อดูค่าคอมและสินค้าที่ขายได้จากออเดอร์ในช่วงนั้น, แสดง Showcase ทั้งหมดเป็นตารางหัวคอลัมน์แบบเลื่อนได้และเพิ่ม–ลบผ่าน TikTok API, รวมค่าคอมข้ามหลายช่อง และจัด Showcase A–F หลังตรวจ ownership, scope และการยืนยันใน UI
