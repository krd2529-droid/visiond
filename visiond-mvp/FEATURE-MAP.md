...
- รหัส UI: company-course grid และ lesson manager มี `data-feature="COURSE-ADMIN-001"`; lesson manager ต้องฝังอยู่ภายในตะกร้าสร้างคอร์สเดียวกับข้อมูลคอร์ส บันทึกร่าง และเผยแพร่ ไม่แยกเป็น workspace นอกตะกร้า; ตัวเลือกบัญชีต้องเป็นการ์ดชิดซ้ายที่แสดงสถานะเลือกทั้งใบและรองรับ focus keyboard; คง form, confirmation, loading/error และ theme เดิม
