...
- จำนวน EP: หลังบ้านตะกร้าคอร์สบริษัทห้ามแสดงช่องกรอกจำนวนบทเรียน ให้แสดงจำนวนจาก `lesson_count`/รายการ `course_lessons` ที่มีจริงเท่านั้น และห้ามแสดงอัตราส่วนเทียบยอดที่กรอกเอง
