...
- การยืนยันหลาย EP: การบันทึกคิว EP ต้อง GET ตรวจ `has_video`/`has_pdf` ของ lesson id ที่เพิ่งส่งก่อน `shift()` บล็อกออกจากคิว หากยังไม่ยืนยันต้องคงบล็อกและ File object ไว้พร้อมแจ้งข้อผิดพลาด; retry ต้อง POST ไป lesson id เดิมที่สร้างสำเร็จบางส่วนแล้วเพื่อไม่สร้าง EP ซ้ำ
