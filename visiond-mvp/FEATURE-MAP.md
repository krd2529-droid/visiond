...
- ห้ามกระทบข้อมูล: product และ course ต้องสร้างสัมพันธ์กัน; active สะท้อน `products.status` published/draft; `total_minutes` เป็นเวลาเนื้อหารวมที่ Boss ระบุตอนสร้างและไม่ถูกการเพิ่ม/ลบ EP เขียนทับ; บันทึกร่างทั้งตะกร้าต้องยอมรับข้อมูลคอร์สที่ยังกรอกไม่ครบและเก็บ EP ที่กรอกแม้ยังไม่มีไฟล์เพื่อกลับมาแก้ได้ แต่ publish ต้องตรวจชื่อคอร์ส ผู้สอน ราคา เวลา จำนวน EP และนับเฉพาะ EP ที่มีคลิปหรือเอกสาร; ลบบทเรียนเฉพาะ course เดียวกันและลบ DB ก่อน object
