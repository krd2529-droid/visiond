...
- Digital commerce boundary: v0.14.407 ล็อก contract; v0.14.408 เปิด product detail; v0.14.409 เปิด order create/status ในตารางแยกด้วย `commerce:write|read`, external ID + idempotency, customer ต้อง sync และ active, สินค้าไม่เกิน 100 รายการและ VisionD คำนวณราคาจาก published products; สถานะเริ่ม `pending_payment` เท่านั้น ยังห้ามอนุมัติชำระ/ออกสิทธิ์; `/orders/sync` เป็น reconciliation เท่านั้น, API 1 บาทไม่หักลูกค้า และ Partner API ห้ามคืนไฟล์หรือ permanent download URL
