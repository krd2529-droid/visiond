...
- ข้อมูล: `tiktok_channels` เก็บชื่อและลิงก์แยกแต่ละช่อง; `tiktok_analysis_runs` และ `tiktok_analysis_images` เก็บการบ้าน ผลวิเคราะห์ และภาพแยกตามช่อง; `tiktok_channel_products` รวมสินค้าและลิงก์โดยไม่สร้างชื่อซ้ำ พร้อมประเภท A–F (F คือไม่ควรยุ่งและต้องมีเหตุผลรองรับ)
- กฎ: ห้ามแต่งตัวเลขที่ไม่มีในภาพ, รับสูงสุด 30 รูป/รอบ รูปละ 5 MB รวมไม่เกิน 25 MB และไม่บันทึกผลปลอมเมื่อ AI ไม่พร้อม
