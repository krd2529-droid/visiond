...
- การเพิ่มบล็อก EP: หน้าเริ่มด้วย editor EP 1; ทุกครั้งที่กด “เพิ่ม EP” ต้องเก็บค่าของบล็อกเดิมไว้ในคิวบนหน้าและเปิด editor EP ถัดไปทันทีโดยไม่รอ API หรืออัปโหลด จากนั้นปุ่มบันทึกร่างทั้งตะกร้าจึงส่งบล็อกตามลำดับ โดยบล็อกที่ส่งสำเร็จต้องถูกนำออกจากคิวเพื่อไม่สร้างซ้ำเมื่อ retry
- การแยกระบบ: หน้า `/admin-courses.html` ใช้โครงฟอร์มตะกร้าและการ์ด EP แบบเดียวกับ workspace คอร์ส แต่บันทึกผ่าน Admin company API เท่านั้น ไม่มี seller review หรือข้อความ 50/50; ปุ่ม “บันทึกร่าง” สร้าง/อัปเดต draft ได้ก่อนมี EP; ปุ่มเผยแพร่เปิดเมื่อ EP ที่มีสื่อครบจำนวน แล้วอนุมัติ/เปิดขายตรงโดยไม่ส่งตรวจ ส่วน review พาร์ตเนอร์อยู่ `/admin-course-reviews.html`
