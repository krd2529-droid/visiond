...
- ข้อมูล: `tiktok_channels` เก็บชื่อและลิงก์แยกแต่ละช่อง; `tiktok_analysis_runs` และ `tiktok_analysis_images` เก็บการบ้าน ผลวิเคราะห์ และภาพแยกตามช่อง; `tiktok_channel_products` รวมลิสต์สินค้านางฟ้าและลิงก์โดยไม่สร้างชื่อซ้ำ
