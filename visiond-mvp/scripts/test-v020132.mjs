...
assert.ok(['v0.20.132', 'v0.20.133', 'v0.20.134'].includes((await text('VERSION.txt')).trim()));
assert.match(await text('public/index.html'), /WEB v0\.20\.(?:132|133|134)/);
assert.match(await text('public/admin.html'), /ADMIN v0\.20\.(?:132|133|134)/);
assert.match(await text('public/live-center.html'), /live-center\.css\?v=020(?:132|133|134)/);
assert.match(await text('public/live-center.html'), /live-center\.js\?v=020(?:132|133|134)/);
...
assert.match(openerHtml, /live-center\.css\?v=020(?:132|133|134)/);
assert.match(openerHtml, /live-package-open\.js\?v=020(?:132|133|134)/);
