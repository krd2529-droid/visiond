...
for(const html of [indexHtml,adminHtml])assert.match(html,/v0\.20\.58/);
for(const html of [indexHtml,digitalHtml])assert.match(html,/catalog-sync\.js\?v=02058/);
assert.match(cartHtml,/cart\.js\?v=02057/);
assert.equal(version.trim(),'v0.20.58');
