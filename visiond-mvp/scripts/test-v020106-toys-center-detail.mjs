...
assert.match(html,/toys-center\.css\?v=020119/);assert.match(html,/toyscenter\.js\?v=020114/);
...
assert.equal(read('VERSION.txt').trim(),'v0.20.120');assert.match(read('public/index.html'),/WEB v0\.20\.120/);assert.match(read('public/admin.html'),/ADMIN v0\.20\.120/);
