...
assert.equal(read('VERSION.txt').trim(),'v0.20.118');
...
console.log('PASS v0.20.118 foreground bootstrap, exact recovery CTA, same-command-only dispatch, bounded polling and unchanged security boundary');
