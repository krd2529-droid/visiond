...
assert.equal(version.trim(), "v0.14.262");
assert.match(index,/WEB v0\.14\.262/);assert.match(admin,/ADMIN v0\.14\.262/);
assert.match(admin,/id="pdfCoverCreatorButton"[\s\S]*สร้างปก PDF/);
assert.match(admin,/id="pdfCoverCreatorDialog"/);assert.match(admin,/admin-pdf-cover\.js\?v=014262/);
