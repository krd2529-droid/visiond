...
assert.equal(read('VERSION.txt').trim(),'v0.20.117');assert.match(html,/v0\.20\.117/);assert.match(html,/tiktok-analyzer\.js\?v=02165/);assert.match(html,/tiktok-analyzer\.css\?v=02103/);
