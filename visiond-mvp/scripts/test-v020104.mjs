...
assert.equal(read('VERSION.txt').trim(),'v0.20.107');assert.match(html,/v0\.20\.107/);assert.match(html,/tiktok-analyzer\.js\?v=02163/);assert.match(html,/tiktok-analyzer\.css\?v=02102/);
