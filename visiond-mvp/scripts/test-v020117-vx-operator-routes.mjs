...
sqlite.close();
console.log('PASS v0.20.120 real analyzer/connections routes, Boss effective-owner mutation, ordinary-user isolation, zero delegated financial SQL/R2/request-time DDL, and analyzer/profile/shop/add/remove/disconnect provider-race write denial');
