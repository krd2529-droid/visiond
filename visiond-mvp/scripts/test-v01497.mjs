...
for(const source of [home,cart])assert.match(source,/visiond-bundle-promo\.gif\?v=01497/);assert.doesNotMatch(home,/visiond-bundle-promo-v2\.png/);
...
assert.match(roadmap,/animated four-frame looping bundle GIF/);assert.equal(fs.readFileSync('VERSION.txt','utf8').trim(),'v0.14.97');
