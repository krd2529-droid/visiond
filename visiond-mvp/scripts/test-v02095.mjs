...
assert.match(html,/<button class="vds-btn vds-btn--secondary" type="button" data-inventory="kept" data-product-name=/);
assert.match(html,/data-product-grade="E"/);assert.match(html,/class="ai-concept-status" data-ai-search-status role="status"/);assert.match(html,/&lt;img>/);
...
assert.equal((html.match(/<button /g)||[]).length,2);assert.ok(!html.includes('<img>'));
