...
assert.match(version.trim(),/^v0\.14\.(250|251)$/);assert.match(index,/WEB v0\.14\.(250|251)/);assert.match(admin,/ADMIN v0\.14\.(250|251)/);assert.match(page,/v0\.14\.(250|251)/);assert.match(page,/build 014(250|251)/);
