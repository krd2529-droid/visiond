...
assert.equal((html.match(/\.heic,\.heif/g)||[]).length,2);assert.match(html,/toys-center-admin\.js\?v=020120/);assert.match(html,/toys-center\.css\?v=020119/);assert.match(html,/v0\.20\.120/);
