...
assert.match(version.trim(),/^v0\.14\.(192|193|194)$/);assert.match(index,/WEB v0\.14\.(192|193|194)/);assert.match(admin,/ADMIN v0\.14\.(192|193|194)/);assert.match(admin,/href="\/v12-connect\.html"[\s\S]*V12[\s\S]*V Connect/);
