...
assert.match(version.trim(),/^v0\.14\.(?:19[2-9]|2[0-3][0-9]|24[0-7])$/);assert.match(index,/WEB v0\.14\.(?:19[2-9]|2[0-3][0-9]|24[0-7])/);assert.match(admin,/ADMIN v0\.14\.(?:19[2-9]|2[0-3][0-9]|24[0-7])/);assert.match(admin,/href="\/v12-connect\.html"[\s\S]*V12[\s\S]*V Connect/);
