...
assert.ok(['v0.20.129','v0.20.130','v0.20.131','v0.20.132'].includes((await text('VERSION.txt')).trim()));
assert.match(await text('public/index.html'), /WEB v0\.20\.(?:129|130|131|132)/);
assert.match(await text('public/admin.html'), /ADMIN v0\.20\.(?:129|130|131|132)/);
assert.match(await text('public/live-center.html'), /live-center\.css\?v=020(?:129|130|131|132)/);
assert.match(await text('public/live-center.html'), /live-center\.js\?v=020(?:129|130|131|132)/);
const openerHtml = await text('public/live-package-open.html');
assert.match(openerHtml, /live-center\.css\?v=020(?:129|130|131|132)/);
assert.match(openerHtml, /live-package-open\.js\?v=020(?:129|130|131|132)/);
