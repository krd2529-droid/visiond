...
assert.match(client, /message\.textContent=error\.message\|\|"โหลดข้อมูลช่องไม่สำเร็จ";showToast\(message\.textContent,"error"\)/, "current-channel detail-load failures must remain visible without replacing the channel list");
