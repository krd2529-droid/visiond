...
const files=['VISIOND-PARTNER-API-PROTOCOL.md','docs/PARTNER-API-WEB2-INTEGRATION.md','docs/examples/partner-api-web2.http','integrations/web2/.env.example','integrations/web2/README.md','integrations/web2/visiond-partner-client.mjs','functions/_partner_api.js','functions/_partner_sync.js','functions/_partner_commerce.js','functions/_partner_webhook.js','functions/api/partner/v1/products/index.js','functions/api/partner/v1/products/[id].js','functions/api/partner/v1/commerce/orders/index.js','functions/api/partner/v1/commerce/orders/[externalId].js','functions/api/partner/v1/customers/sync.js','functions/api/partner/v1/orders/sync.js','functions/api/admin/partner-websites/[id]/commerce.js','functions/api/admin/partner-websites/[id]/commerce/[orderId]/fulfill.js','functions/api/commerce/claim.js','public/partner-commerce-claim.js','functions/api/admin/partner-websites/[id]/e2e.js'];
...
const starterEnv=fs.readFileSync('integrations/web2/.env.example','utf8');
assert.match(starterEnv,/VISIOND_CLIENT_ID=<CLIENT_ID_FROM_SECRET_MANAGER>/);assert.match(starterEnv,/VISIOND_CLIENT_SECRET=<CLIENT_SECRET_FROM_SECRET_MANAGER>/);
