...
const files=['VISIOND-PARTNER-API-PROTOCOL.md','docs/PARTNER-API-WEB2-INTEGRATION.md','docs/examples/partner-api-web2.http','integrations/web2/.env.example','integrations/web2/README.md','integrations/web2/visiond-partner-client.mjs','functions/_partner_api.js','functions/_partner_sync.js','functions/_partner_webhook.js','functions/api/partner/v1/customers/sync.js','functions/api/partner/v1/orders/sync.js','functions/api/admin/partner-websites/[id]/e2e.js'];
