...
sqlite.close();
console.log('PASS v0.20.120 bounded/abort-safe TikTok avatar mirror, same-digest/CAS/race preservation, strict R2 metadata binding, no secret projection, and Boss/Testervx/non-owner authenticated media matrix');
