...
assert.equal(version.trim(),'v0.20.67');assert.match(indexHtml,/WEB v0\.20\.67/);assert.match(adminHtml,/ADMIN v0\.20\.67/);
assert.match(html,/work-links\.js\?v=02067/);assert.match(html,/work-links\.css\?v=014590/);
console.log('PASS v0.20.67 work-links migration, indexed keyset, strict/atomic API and document-memory request races');
