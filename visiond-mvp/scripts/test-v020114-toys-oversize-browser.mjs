...
console.log('PASS v0.20.117 installed Chrome genuine oversized JPEG/PNG/WEBP/HEIC orientation, alpha, exact AI/save cache, cover, concurrency2, stale queue and zero-request failure');
