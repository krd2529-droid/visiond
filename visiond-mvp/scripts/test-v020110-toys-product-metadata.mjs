...
assert.equal((await read('VERSION.txt')).trim(),'v0.20.120');assert.match(html,/v0\.20\.120/);assert.match(html,/toys-center-admin\.js\?v=020120/);assert.match(await read('public/toyscenter.html'),/toyscenter\.js\?v=020114/);
sqlite.close();
