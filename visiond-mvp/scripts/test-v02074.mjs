...
const setupPage=readFileSync('public/launcher-setup.html','utf8');assert.match(setupPage,/0\.20\.76 ขึ้นไป/);assert.match(setupPage,/0\.20\.75 หรือต่ำกว่า/);assert.doesNotMatch(setupPage,/0\.20\.73 ขึ้นไป/);
