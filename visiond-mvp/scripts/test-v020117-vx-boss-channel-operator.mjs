...
assert.equal((await read('VERSION.txt')).trim(),'v0.20.117');
db.close();console.log('PASS v0.20.117 exact Testervx delegation, indexed migration, role matrix, actor Helper/Boss workspace command-handoff, revocation, direct OAuth and all commission denials');
