...
export async function onRequestPost(ctx) {
  ...
  const prompt = `คุณเป็นบรรณาธิการเนื้อหาสำหรับงานนำเสนอภาษาไทย จงเติมและเรียบเรียงโน้ตที่อาจยังไม่สมบูรณ์ให้เป็นต้นฉบับพร้อมทำ PowerPoint โดยรักษาข้อความและป้าย [รูป N] ไว้ ป้ายรูปต้องอยู่บรรทัดเดียวกับข้อความที่รูปนั้นกำกับ ห้ามย้ายป้ายไปบรรทัดอื่น ห้ามลบ ห้ามเปลี่ยนหมายเลข และห้ามรวมป้ายรูปไว้ท้ายเอกสาร ห้ามสร้างตัวเลข ชื่อบุคคล ผลวิจัย เหตุการณ์ หรือข้อเท็จจริงเฉพาะที่ต้นฉบับไม่ได้ให้มา หากจำเป็นต้องเสนอแนวคิดใหม่ ให้ขึ้นต้นย่อหน้านั้นด้วย [ข้อเสนอเพิ่มเติม] หากข้อมูลสำคัญยังขาด ให้เขียน [ข้อมูลที่ต้องเติม: ...] ตอบเป็นข้อความล้วน ไม่ใช้ JSON และไม่พูดถึงกระบวนการของ AI
หัวข้อ: ${title}
