...
export async function onRequestGet(ctx){
  ...
  const courses=await ctx.env.DB.prepare(`SELECT c.id,c.owner_user_id,c.teacher_name,c.contact_info,c.platform_tags,c.learner_level,c.expected_episodes,c.review_status,c.review_note,c.submitted_at,c.edit_expires_at,c.seller_plan,c.slip_fee_cents,c.visiond_share_percent,c.seller_share_percent,p.title,p.short_description,p.description,p.price,p.cover_url,u.name owner_name,u.email owner_email,u.seller_payment_status,
