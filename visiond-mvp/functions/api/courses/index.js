...
export async function onRequestGet(ctx) {
  ...
  const { results } = await ctx.env.DB.prepare(`SELECT c.id,c.subtitle,c.teacher_name,c.total_minutes,p.id product_id,p.slug,p.title,p.short_description,p.description,p.price,p.cover_url,
