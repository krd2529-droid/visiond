...
const dailyProductListPrompt=`กฎรายการสินค้า: daily_product_list เป็นรายชื่อสินค้าพร้อม Ranking สำหรับเตรียมสร้างคลิป ไม่ใช่แผนคลิป ให้สร้างสูงสุด 40 รายการที่ไม่ซ้ำ เรียง ranking_score จากมากไปน้อย และใส่ rank ต่อเนื่องตั้งแต่ 1 โดย 30 อันแรกเป็นชุดหลักและ 10 อันท้ายเป็นตัวสำรอง แต่ละรายการมี rank, product ชื่อสินค้าเต็ม, product_type เกรด A-E, ranking_score 0-100 และ ranking_reason เหตุผลสั้นจากหลักฐานที่มีจริง หากหลักฐานไม่พอให้ ranking_score เป็น null และระบุใน ranking_reason ห้ามแต่งคะแนน ห้ามกำหนดเวลา Hook มุมขาย รูปแบบ CTA หรือเงื่อนไขผ่าน และห้ามใส่สินค้า F`;
