...
const activeProductPrompt=`กฎ A/B เพิ่มเติม: สินค้าเกรด A และ B เป็นสินค้าที่ต้องทำคอนเทนต์ลงต่อเนื่อง ไม่ใช่หยุดหลังจัดเกรด ให้ติดตามผลใหม่ทุกรอบ และเลื่อน B เป็น A เมื่อมีหลักฐานว่ายอดขาย วิว และทราฟฟิกดีขึ้นอย่างต่อเนื่อง ห้ามเลื่อนจากความรู้สึกหรือข้อมูลเพียงครั้งเดียว`;
