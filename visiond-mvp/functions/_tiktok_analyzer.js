...
const dailyProductListPrompt=`กฎรายการสินค้า: daily_product_list เป็นเพียงรายชื่อสินค้าสำหรับเตรียมสร้างคลิปในหนึ่งวัน ไม่ใช่แผนคลิป ให้สร้างสูงสุด 40 รายการ เรียงจากเหมาะสมมากไปน้อย โดย 30 อันแรกเป็นชุดหลักและ 10 อันท้ายเป็นตัวสำรองสำหรับสลับแทน แต่ละรายการมีเฉพาะ product ซึ่งเป็นชื่อสินค้าเต็ม และ product_type ซึ่งต้องเป็น A, B, C, D หรือ E ตามเกรดเดียวกันกับตาราง Showcase ห้ามกำหนดเวลา Hook มุมขาย รูปแบบ CTA หรือเงื่อนไขผ่าน ให้เรียงสินค้าไม่ซ้ำกันตามความเหมาะสม และห้ามใส่สินค้า F`;
