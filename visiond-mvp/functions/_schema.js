export async function ensureDatabase(env) {
  ...
  await env.DB.prepare("UPDATE products SET title='สิทธิ์เปิดตะกร้าขายคอร์ส 1 ตะกร้า',short_description='ตะกร้าขายได้ต่อเนื่อง โดยแก้ไขข้อมูลและเนื้อหาได้ 30 วันนับจากวันที่เผยแพร่',updated_at=CURRENT_TIMESTAMP WHERE slug='course-selling-rights'").run();
