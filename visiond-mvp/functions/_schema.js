export async function ensureDatabase(env) {
  ...
  await env.DB.prepare(`INSERT OR IGNORE INTO products(slug,title,short_description,description,price,cover_url,preview_urls,category,file_type,pages,status,source,product_kind)
    VALUES('course-selling-rights-30-days','สิทธิ์ลงขายคอร์ส 1 ตะกร้า แก้ไขได้ 30 วัน','เปิดตะกร้าขายคอร์สออนไลน์ของคุณบน VisionD รับเงินตรง ไม่หักเปอร์เซ็นต์','สิทธิ์ลงขายคอร์สออนไลน์จำนวน 1 ตะกร้า\n\n• สร้างและเปิดขายคอร์สออนไลน์ได้ 1 ตะกร้า\n• แก้ไขชื่อ ราคา รายละเอียด และเนื้อหาได้อิสระภายใน 30 วัน\n• เพิ่มวิดีโอและเอกสารประกอบแยกตาม EP\n• รองรับ PDF, DOCX, XLSX, PPTX และ ZIP\n• กำหนด QR หรือบัญชีรับเงินของเจ้าของคอร์สได้\n• VisionD ตรวจสลิปแบบแมนนวลก่อนปลดล็อกบทเรียน\n• มีหน้ารวมยอดขาย จำนวนออเดอร์ และวันเวลา\n• 1 สิทธิ์ผูกกับ 1 ตะกร้าถาวร การลบตะกร้าไม่คืนสิทธิ์\n• VisionD ดูแลระบบ แต่เจ้าของคอร์สดูแลเนื้อหาของตนเอง',49900,'/assets/course-rights-499-mobile.png','["/assets/course-rights-499-mobile.png","/assets/course-rights-conditions-part-1.png","/assets/course-rights-conditions-part-2.png"]','resale-rights','สิทธิ์ใช้งาน',1,'published','system-course-rights','product')`).run();
  ...
  await env.DB.prepare(`UPDATE products SET preview_urls='["/assets/course-rights-499-mobile.png","/assets/course-rights-conditions-part-1.png","/assets/course-rights-conditions-part-2.png"]',updated_at=CURRENT_TIMESTAMP WHERE slug='course-selling-rights-30-days' AND (preview_urls IS NULL OR preview_urls='' OR preview_urls='["/assets/course-rights-499-mobile.png"]')`).run();
