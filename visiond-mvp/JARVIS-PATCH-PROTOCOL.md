...
- PD-SET-001 ห้ามจำกัดขนาดไฟล์ต้นทางหรือจำนวนรายการภายใน ZIP ใน Frontend เพราะยังประมวลผลในเครื่องผู้ใช้; ให้ตรวจเพดานเฉพาะไฟล์ผลลัพธ์ก่อนเรียก API
- PD-SET-001 ต้องสร้างตะกร้าร่างทีละรายการตามคิว แสดงสถานะรายตะกร้า ทำรายการถัดไปต่อเมื่อรายการหนึ่งผิดพลาด และ Retry เฉพาะรายการที่ไม่สำเร็จโดยไม่สร้างรายการสำเร็จซ้ำ
