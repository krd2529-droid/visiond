...
## v0.8.3
- แก้ระบบสมัครสมาชิกสำหรับ Cloudflare D1 Binding ชื่อ `DB`
- สมัครครั้งแรกแล้วสร้างตารางระบบทั้งหมดให้อัตโนมัติ ไม่ต้องรัน SQL เอง
- ชื่อและนามสกุลรองรับภาษาไทย
- ไอดีสมาชิกรองรับเฉพาะอังกฤษ ตัวเลข จุด ขีดกลาง และขีดล่าง
- เพิ่มการจัดเก็บเบอร์โทรศัพท์ของสมาชิก
