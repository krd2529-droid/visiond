...
# กฎหน้าหลังบ้านแบบ Real-time
- หน้าแชตและงาน Real-time ต้องแสดงสถานะโหลด/ข้อผิดพลาดในพื้นที่ใช้งาน ห้ามปล่อยพื้นที่ว่างโดยไม่มีคำอธิบาย
- ทุกแพตที่แก้หน้าเฉพาะทางต้องอัปเดตเลขเวอร์ชันของ HTML, JS และ CSS ให้ตรงกันเพื่อป้องกัน cache คนละรุ่น
