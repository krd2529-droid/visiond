  ...
  courseList.querySelectorAll("[data-buy]").forEach(
    (btn) =>
      (btn.onclick = () => {
        ...
        saveCart({
          ...c,
          category_label: c.course_type==='resale_rights'?"สิทธิ์ลงขายคอร์ส":"คอร์สออนไลน์",
