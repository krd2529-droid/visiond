...
import("/mouse-ui.js?v=014130");
import('/nav-account.js?v=014130');
(() => {
  ...
  if(!document.querySelector('link[href^="/promotion.css"]'))document.head.insertAdjacentHTML('beforeend','<link rel="stylesheet" href="/promotion.css?v=014130">');
...
import("/nav-account.js?v=014130").then((module) => module.initAccountNav());
