...
(() => {
  ...
  document.head.insertAdjacentHTML(
    "beforeend",
    "<style>.vd-card[hidden]{display:none!important}.vd-cover>a{display:block;width:100%;height:100%}.vd-cover-slider>a{position:relative!important;z-index:1!important}.vd-cover img[hidden]{display:none!important}.vd-cover-slider{touch-action:pan-y;user-select:none}.vd-image-total{position:absolute;z-index:8;right:8px;bottom:8px;padding:7px 10px;border:2px solid rgba(255,255,255,.9);border-radius:999px;background:#087d77;color:#fff;box-shadow:0 5px 16px rgba(0,0,0,.24);font-size:12px;font-weight:900}.vd-cover-slider .vd-image-total{bottom:34px}.vd-cover-slider .vd-slide-prev,.vd-cover-slider .vd-slide-next{position:absolute!important;z-index:12!important;top:50%;transform:translateY(-50%);display:grid;place-items:center;width:38px;height:52px;border:0;background:rgba(7,63,61,.88);color:#fff;font-size:28px;cursor:pointer;pointer-events:auto!important}.vd-cover-slider .vd-slide-prev{left:0;border-radius:0 10px 10px 0}.vd-cover-slider .vd-slide-next{right:0;border-radius:10px 0 0 10px}.vd-slide-count{position:absolute;z-index:8;left:50%;bottom:7px;transform:translateX(-50%);padding:4px 7px;border-radius:999px;background:rgba(7,63,61,.8);color:#fff;font-size:9px;font-weight:900}@media(pointer:coarse){.vd-cover-slider .vd-slide-prev,.vd-cover-slider .vd-slide-next{opacity:.9;width:42px;height:56px}}</style>",
  );
