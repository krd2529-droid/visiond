...
import("/mouse-ui.js?v=014104");
import('/nav-account.js?v=014104');
(() => {
  ...
  if(!document.querySelector('link[href^="/promotion.css"]'))document.head.insertAdjacentHTML('beforeend','<link rel="stylesheet" href="/promotion.css?v=014104">');
...
import("/nav-account.js?v=014104").then((module) => module.initAccountNav());
