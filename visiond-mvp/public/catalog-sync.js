import("/facebook-chat.js?v=014103");
import("/mouse-ui.js?v=014103");
import('/nav-account.js?v=014103');
(() => {
  ...
  if(!document.querySelector('link[href^="/promotion.css"]'))document.head.insertAdjacentHTML('beforeend','<link rel="stylesheet" href="/promotion.css?v=014103">');
...
import("/nav-account.js?v=014103").then((module) => module.initAccountNav());
