...
(()=>{
  ...
  const phrases=[
    ...
    ['สอบถามสินค้าดิจิทัล คอร์สเรียน สิทธิ์ลงขายคอร์ส หรือการใช้งานเว็บไซต์ ทีมงาน VisionD พร้อมช่วยตรวจสอบให้','Ask about digital products, online courses, course-selling rights, or using the website. VisionD is ready to help.'],
    ...
    ['เลือกใช้แบบรายเดือนหรือรายปี ดาวน์โหลดสินค้าทุกชิ้นในหมวดนั้น และรับสิทธิ์สินค้าใหม่ที่เพิ่มเข้ามาตลอดอายุสมาชิก','Choose monthly or annual access to download every product in a category, including new products added while your membership is active.'],
    ...
    ['รวมสินค้าที่ซื้อขาดและสิทธิ์ Member รายหมวด','Includes one-time purchases and category memberships.'],
