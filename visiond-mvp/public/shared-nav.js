import('/facebook-chat.js?v=014130');
document.addEventListener('DOMContentLoaded',async()=>{
  ...
  if(nav){
    ...
    const links=[['nav-home-link','/','หน้าแรก'],['','/digital-products.html','สินค้าดิจิทัล'],['nav-course-basket','/course-seller.html','ศูนย์จัดการคอร์ส'],['','/courses.html','ระบบ V-Learning'],['','/bots.html','VBot'],['','/blog.html','บทความ'],['','/about.html','เกี่ยวกับเรา']];
  ...
  await import('/nav-account.js?v=014130');
});
import('/i18n.js?v=014130');
