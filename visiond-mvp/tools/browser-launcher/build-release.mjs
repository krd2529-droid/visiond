...
const version='0.20.73',dir=resolve('public/downloads/visiond-helper',version),exe=join(dir,'VisionD-Helper-Setup.exe'),zip=join(dir,'VisionD-Helper-Source.zip');
