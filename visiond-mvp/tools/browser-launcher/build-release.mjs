...
const version='0.20.78',dir=resolve('public/downloads/visiond-helper',version),exe=join(dir,'VisionD-Helper-Setup.exe'),zip=join(dir,'VisionD-Helper-Source.zip');
...
const sources=['Launcher.cs','Setup.cs','InstallState.ps1','install.ps1','uninstall.ps1','README.md','build-release.mjs','single-tab-probe.mjs','LICENSE'];
