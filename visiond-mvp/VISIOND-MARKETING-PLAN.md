...
# ยืนยันรุ่นจาก Production จริง (v0.14.180)

- ใช้เลขเวอร์ชันบนเว็บจริงเป็นหลักฐานการเผยแพร่ ไม่สรุปจาก Git commit เพียงอย่างเดียว
- ห้ามแสดงเลขใหม่บน snapshot เก่าโดยไม่มีโค้ด production รุ่นเดียวกัน
